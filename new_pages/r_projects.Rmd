...
3) El paquete **rio** para importar/exportar
    -`import()` y `export()` manejan cualquier tipo de archivo por su extensión (por ejemplo, .csv, .xlsx, .png)
...
* Si quieres clonar un repositorio de Github, selecciona la tercera opción "Version Control" y luego "Git". Consulta la página [Control de versiones y colaboración con Git y Github](#version-control-and-collaboration-with-) para más detalles.
...
Un método más complicado implicaría utilizar Github o una plataforma similar para el control de versiones. Consulta la página sobre [Control de versiones y colaboración con Git y Github](#version-control-and-collaboration-with-).

Un consejo es que puedes realizas búsquedas en todo un proyecto o carpeta utilizando la herramienta "Buscar en archivos" (menú Edición).
Puedes buscar e incluso reemplazar líneas de script en varios archivos.
