...
Para ver las versiones de R, RStudio y los paquetes de R utilizados durante la producción de este manual, consulta la página de [notas editoriales y técnicas](#editorial-and_technical-notes).
...
pacman::p_load(
     ...
     distcrete,    # Distribuciones discretas con delay 
