...
### Esto suena complicado, yo no soy un programador {#this-sounds-complicated-i-am-not-a-programmer}
...
### Instalar una interfaz gráfica (opcional pero recomendable) {#install-an-interface-optional-but-recommended}
...
Es posible que se te ofrezca configurar la autenticación de dos pasos con una aplicación en tu teléfono. Lee más en [los documentos de ayuda](https://docs.github.com/es/github/authenticating-to-github/securing-your-account-with-two-factor-authentication-2fa) de Github.
...
### Commits (**Consolidaciones**) {#commits}
...
### Repositorios locales y remotos {#local-and-remote-repositories}
...
### Archivos de inicio {#start-up-files}
...
### Crear un nuevo repositorio en Github {#create-a-new-repository-in-github}
...
### Clonar desde un repositorio de Github {#clone-from-a-github-repository}
...
#### En Github Desktop {#in-github-desktop}
...
### Nuevo repositorio de Github a partir de un proyecto R existente {#new-github-repo-from-existing-r-project}
...
### ¿Qué aspecto tiene ahora? {#what-does-it-look-like-now}

#### En RStudio {#in-rstudio-1}
...
#### En Github Desktop {#in-github-desktop-1}
...
### Resumen del proceso {#process-overview}
...
### En el panel Git de Rstudio {#in-rstudio-git-pane}
...
### En Github Desktop {#in-github-desktop-2}
...
### En Github Desktop {#in-github-desktop-3}
...
### Modificar una consolidación anterior {#amend-a-previous-commit}
...
#### En Github Desktop {#in-github-desktop-4}
...
### Quiero actualizarme pero tengo trabajo local {#i-want-to-pull-but-i-have-local-work}
...
### Localmente en Github Desktop {#locally-in-github-desktop}
...
### En Github: envío de pull requests {#in-github-submitting-pull-requests}
...
#### En Github Desktop {#in-github-desktop-5}
...
### Ejemplos de comandos {#sample-commands}
