...
Instala o carga el paquete **stringr** y otros paquetes **tidyverse**.or load the **stringr** and other **tidyverse** packages.
...
[***CAUTION:*** If you do not provide enough `into` values for the new columns, your data may be truncated.]{style="color: orange;"}
...
A vignette on **stringr** can be found [here](https://cran.r-project.org/web/packages/stringr/vignettes/stringr.html)
