...
### Rutas de archivos "relativas" {#relative-file-paths}
...
### Rutas "absolutas" {#absolute-file-paths}  
...
<!-- ======================================================= -->
### Selección manual {#select-file-manually}
...
### Hojas de Excel específicas {#specific-excel-sheets}
...
<!-- ======================================================= -->
### Valores faltantes {#import_missing} 
...
### Gestionar una segunda fila de cabecera {#manage-a-second-header-row}  
...
### Entrada por filas {#entry-by-rows}  
...
### Entrada por columnas {#entry-by-columns}  
...
### Pegar desde el portapapeles {#pasting-from-clipboard}  
...
### Fechas en el nombre del archivo {#dates-in-file-name}  
...
Una vez que tengas este vector de nombres, puedes extraer las fechas de ellos aplicando `str_extract()` de **stringr** utilizando esta expresión regular. Este comando extrae cualquier número en el nombre del archivo (incluyendo cualquier otro carácter en el medio como guiones o barras). Puedes leer más sobre **stringr** en la página [Cadenas y caracteres](#characters-and-strings).
...
### Utiliza la información del archivo {#use-the-file-info}  
...
### Datos de acceso público {#publicly-available-data}  
...
### Con el paquete **rio** {#with-rio-package}
...
[Capítulo de R 4 Data Science sobre la importación de datos](https://r4ds.had.co.nz/data-import.html#data-import)
