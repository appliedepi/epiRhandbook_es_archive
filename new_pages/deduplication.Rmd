...
Mira los [datos originales](#dedup_data). 
...
<span style="color: orange;">***ATENCIÓN:*** Si se utiliza `distinct()` en datos agrupados, la función se aplicará a cada grupo.</span>
...
<span style="color: orange;">***ATENCIÓN:*** Si utilizas `arrange()`, especifica .`by_group = TRUE` para que los datos se ordenen dentro de cada grupo.</span>
...
Arriba, por ejemplo, podemos ver que sólo se conservó la fila de Amrish del 5 de enero, y sólo se conservó la fila de Brian del 7 de enero. Mira los [datos originales](#dedup_data).   
