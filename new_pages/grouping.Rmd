...
Esto significa que el número de recuento de un grupo, en la nueva columna n, se imprimirá en cada fila del grupo. Para fines de demostración, añadimos esta columna y luego reordenamos las columnas para facilitar la visualización. Consulta la sección siguiente sobre el [filtro del tamaño del grupo](#group_filter_grp_size) para ver otro ejemplo. 
