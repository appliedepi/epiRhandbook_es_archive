...
* Un archivo *.here*, para que puedas utilizar el paquete **here** para convocar a los archivos de las subcarpetas gracias a su relación con esta carpeta raíz (véase la página de [proyectos de R](#r-projects) para más detalles)
...
### Compilar por nombre {#compile-by-name} {.unnumbered}   
...
### Compilación por número {#compile-by-number} {.unnumbered}
...
### Compilar todos {#compile-all} {.unnumbered}
...
### Compilar desde la subcarpeta {#compile-from-sub-folder} {.unnumbered} 
...
### Parametrización {#parameterization} {.unnumbered}
...
### Utilizar un "run-file" {#using-a-run-file} {.unnumbered} 
