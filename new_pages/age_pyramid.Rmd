...
Importa y visualiza los datos de población (véase la página de [descarga del manual y de los datos](#download-handbook-and-data)):
...
Importa los datos (consulta la página de [descarga de manuales y datos](#download-handbook-and-data) si lo desea).
...
[documentación de la apirámide](https://cran.r-project.org/web/packages/apyramid/vignettes/intro.html)
