...
### Cargar paquetes {#load-packages-25} {.unnumbered}  
...
### Importar datos {#import-data-23} {.unnumbered}  

Los datos de esta página pueden descargarse con las instrucciones de la página de [descarga del manual y los datos](#download-handbook-and-data).
...
### Limpiar e inspeccionar {#clean-and-inspect} {.unnumbered} 
...
### Diferentes configuraciones de los árboles {#different-tree-layouts} {.unnumbered} 
...
### Árbol simple con datos de muestra {#simple-tree-plus-sample-data} {.unnumbered}  
...
### Ampliar el zoom {#zoom-in} {.unnumbered}  
...
### Ramas colapsadas {#collapsing-branches} {.unnumbered}
...
### Subconjunto de un árbol {#subsetting-a-tree} {.unnumbered}
...
### Rotación de nodos en un árbol {#rotating-nodes-in-a-tree} {.unnumbered} 
...
### Ejemplo de sub-árbol con anotación de datos {#example-subtree-with-sample-data-annotation} {.unnumbered}
