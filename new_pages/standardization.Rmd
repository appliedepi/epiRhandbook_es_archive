...
<span style="color: orange;">***PRECAUCIÓN:*** Si intenta utilizar `str_replace_all()` para eliminar un *símbolo* de suma, no funcionará porque es un símbolo especial. "Escapa" de los especiales poniendo dos barras invertidas delante, como en `str_replace_call(columna, "\\+", "")`. </span>
