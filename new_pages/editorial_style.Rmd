...
Consulta la página sobre [los fundamentos de R](#r-basics) para saber más sobre los paquetes y las funciones.
...
## Información de la sesión (R, RStudio, paquetes)
